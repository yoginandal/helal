...
// Image imports (assuming your bundler is configured for this, like in Create React App)
const Testimonials1 = "src/assets/user_images/aditya.jpg";
const Testimonials2 = "src/assets/user_images/daniaskhata.jpg";
const Testimonials3 = "src/assets/user_images/Itha.jpg";
const Testimonials4 = "src/assets/user_images/jaideep.jpg";
const Testimonials5 = "src/assets/user_images/niraj.jpg";
const Testimonials6 = "src/assets/user_images/Parameshwar.jpg";
const Testimonials7 = "src/assets/user_images/swapnil.jpg";
const Testimonials8 = "src/assets/user_images/Umesh.jpeg";
const Testimonials9 = "src/assets/user_images/Ankit.jpeg";
const Testimonials10 = "src/assets/user_images/Venkatesh.jpeg";
const goc = "src/assets/user_images/goc.png";
const jpmc = "src/assets/user_images/jpmc-logo.svg";
const naukri = "src/assets/user_images/naukri.svg";
const microsoft = "src/assets/user_images/microsoft.png";
const prodapt = "src/assets/user_images/prodapt.svg";
const sbi = "src/assets/user_images/SBI_Logo.png";
const citi = "src/assets/user_images/citi-logo.svg";
const cognizant = "src/assets/user_images/cognizant.svg";
const dabur = "src/assets/user_images/dabur.png";
const innova = "src/assets/user_images/innova-logo.svg";
...
const TestimonialSection = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-blue-200 via-blue-50 to-blue-200 pb-16 sm:pb-20">
      ...
      <a href="/alumni" className="flex lg:hidden justify-center">
        <Button
          className="group gap-0 text-white px-0 py-0 h-0 rounded-none"
          size="lg"
        >
